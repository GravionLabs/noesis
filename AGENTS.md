# AGENTS.md – Contexteur Agent Architecture

This document describes the Contexteur system architecture, component roles,
...
|---|---|---|
| `ConnectionStrings__contexteur` | — | Postgres connection string |
...
| Variable | Default | Description |
|---|---|---|
| `DATABASE_URL` | `postgres://contexteur:contexteur_dev@localhost:5432/contexteur` | Postgres connection string |
